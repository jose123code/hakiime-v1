...
exports.INTERFACE_TYPE = {
    ...
    Flutterwave: Symbol.for('Flutterwave'),
    ConfigurationManager: Symbol.for('ConfigurationManager'),
    RabbitMqConnectionFactory: Symbol.for('RabbitMqConnectionFactory'),
    RabbitMqSingletonConnectionFactory: Symbol.for('RabbitMqSingletonConnectionFactory')
};
